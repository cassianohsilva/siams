function Interpretador() {
	...
	this.listaNaoArit = [{
        ...
        op: 32,
        funcao: function(r1, r2, num){
        	var temp = memoria.getConteudo(r2.valor + Math.abs(num/4));
        	r1.valor = temp & 255;
        	return r1;
        }
     },{
        ...
        op: 35,
        funcao: function(r1, r2, num){
        	r1.valor = memoria.getConteudo(r2.valor + Math.abs(num/4));
        	return r1;
        }
     },{
     	//sb
        ...
        funcao: function(r1, r2, num){
        	...
        	memoria.getConteudo(r2.valor + Math.abs(num/4), temp);
        	return r1;
        }
     },{
     	//sh
        ...
        op: 43,
        funcao: function(r1, r2, num){
        	memoria.getConteudo(r2.valor + Math.abs(num/4), r1.valor);
        	return r1;
     	}
	}];
